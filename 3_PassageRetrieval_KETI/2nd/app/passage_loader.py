...
class SearchManager(object):
    ...
    def search(
        ...
        if tokenized_context is not None:
            ...
            if self.squeeze_vec:
                encoded_context = np.squeeze(encoded_context, axis=1)
        ...
        if self.squeeze_vec:
            encoded_question = np.squeeze(encoded_question, axis=1)
        ...
        for current_hop in range(1, n_hop):
            ...
            if self.squeeze_vec:
                q_sp_encoded = np.squeeze(q_sp_encoded, axis=1)
